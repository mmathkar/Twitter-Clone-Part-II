defmodule Project5Web.Endpoint do
  use Phoenix.Endpoint, otp_app: :project5

  socket "/socket", Project5Web.UserSocket
  ...
  plug Plug.Session,
    store: :cookie,
    key: "_project5_key",
    signing_salt: "i5pfokDc"

  plug Project5Web.Router
